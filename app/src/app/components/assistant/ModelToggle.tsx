...
export const MODELS: ModelOption[] = [
    ...
    { id: "ollama:llama3.1", label: "Llama 3.1 (Ollama)", group: "Local" },
    { id: "ollama:qwen3:8b", label: "Qwen3 8B (Ollama)", group: "Local" },
    { id: "ollama:qwen3:4b", label: "Qwen3 4B (Ollama)", group: "Local" },
];
